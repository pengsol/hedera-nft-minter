...
import ConnectToDiscordButton from '@src/components/shared/modals/ConnectionToDiscordModal/ConnectToDiscord';
...
export default function DiscordConnectionModal() {
